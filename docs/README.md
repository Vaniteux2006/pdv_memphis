...
`test/smoke.js` roda ~**147 verificações** ponta-a-ponta (auth, permissões, upload no
...
(segurança, 49 verificações) e mais três suítes que sobem/limpam o próprio ambiente:
