...
async function createUser({ email, name, password, role }) {
  ...
  const user = {
    ...
    role, passwordHash: bcrypt.hashSync(password, 10), active: true, createdAt: nowISO(),
  };
...
module.exports = {
  ...
  findUserByEmail, findUserById, checkPassword, listUsers, createUser, setPassword, setUserActive, deleteUser,
