...
async function createUser({ email, name, password, role, mustChangePassword, grupo, regiao, telefone, setor, matricula, permissions }) {
...
module.exports = {
  ...
  getConfig, setConfig, reference, promotorExiste, grupoExiste, sugerirPromotores,
